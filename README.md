...
### DkZ Skill Builder -- Actions zu wiederverwendbaren Skills kombinieren
...
![Lines](https://img.shields.io/badge/Lines-836-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-skill-builder.git

# Oeffnen
cd dkz-skill-builder
